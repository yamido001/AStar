...
public class UIButtonColor : UIWidgetContainer
{
	...
	/// <summary>
	/// Add by guozhonglin. same behaviour as tweenTarget.
	/// </summary>
	[HideInInspector][System.NonSerialized] public Color mDefaultTitleColor;
	[HideInInspector][System.NonSerialized] public Color mDisableTitleColor;
	...
	protected virtual void OnInit ()
	{
		...
		if (title != null){
			mDefaultTitleColor = title.color;
			mDisableTitleColor = new Color(151f/255, 151f/255, 151f/255, 1f);
		}
	}
	...
	public void UpdateColor (bool instant)
	{
		...
		UpdateTitleColor(instant);
	}
	
	//Copy UpdateColor
	void UpdateTitleColor(bool instant){
		if (title == null){
			return;
		}
		...
		switch (mState)
		{
		// case State.Hover: tc = TweenColor.Begin(title.gameObject, duration, hover); break;
		// case State.Pressed: tc = TweenColor.Begin(title.gameObject, duration, pressed); break;
		case State.Disabled: tc = TweenColor.Begin(title.gameObject, duration, mDisableTitleColor); break;
		default: tc = TweenColor.Begin(title.gameObject, duration, mDefaultTitleColor); break;
		}
