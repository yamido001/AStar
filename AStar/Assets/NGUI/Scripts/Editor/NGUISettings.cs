...
#region Convenience accessor properties
	...
	static public UILabel.NumShowType numShowTypeStyle
	{
		get { return GetEnum("NGUI NumShowType", UILabel.NumShowType.None); }
		set { SetEnum("NGUI NumShowType", value); }
	}
	...
	static void CopyLabel (UILabel lbl)
	{
		...
		SetEnum("NumShowType", lbl.numberShowType);
	...
	static void PasteLabel (UILabel lbl, bool fully)
	{
		...
		lbl.numberShowType = GetEnum<UILabel.NumShowType>("NumShowType", lbl.numberShowType);
